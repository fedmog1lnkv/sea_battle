...
int Field::make_attack(coordinate coords) {
...
int Field::injure_ship(coordinate coord_attack_ship) {
	...
	// cout << "корабль найден тип " << attacked_ship.type_ship << " хп " <<
	// attacked_ship.hp << " поворот " << attacked_ship.rotate << " координаты:
	// " << attacked_ship.start_coords.x << attacked_ship.start_coords.y <<
	// endl; system("pause");
	attacked_ship.hp--;
